...
- Keep ChromaDB, SearXNG, Ollama, vLLM, llama.cpp, databases, and raw model/provider APIs internal-only.
...
- Common internal-only ports are Odysseus `7000`, SearXNG `8080`, ChromaDB `8100`, Ollama `11434`, and local model/provider APIs such as `8000-8020`.
